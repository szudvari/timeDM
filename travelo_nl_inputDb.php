...
@$dir="/var/local/www/stuff.szallas.travelo.hu/hirlevel/".$folder_name;
//echo $dir;
if (!mkdir($dir)) {
    if (file_exists($dir)) {
...
@$travelo['1l_pic'] = ($_FILES['1l_pic']['name']);
...
@$travelo['1r_pic'] = ($_FILES['1r_pic']['name']);
...
@$travelo['2l_pic'] = ($_FILES['2l_pic']['name']);
...
@$travelo['2r_pic'] = ($_FILES['2r_pic']['name']);
...
@$travelo['3l_pic'] = ($_FILES['3l_pic']['name']);
...
@$travelo['3r_pic'] = ($_FILES['3r_pic']['name']);
...
@$travelo['4l_pic'] = ($_FILES['4l_pic']['name']);
...
@$travelo['4r_pic'] = ($_FILES['4r_pic']['name']);
...
@$travelo['5l_pic'] = ($_FILES['5l_pic']['name']);
...
@$travelo['5r_pic'] = ($_FILES['5r_pic']['name']);
